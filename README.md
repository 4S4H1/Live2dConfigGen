...
面向 Live2D 交互配置的 Windows 节点式编辑器。1.4.3 使用 Python
3.13.14、PySide6 6.11.1 和动态 Qt 共享库，支持 Windows 10/11 x64。
本版本的升级要点和兼容提示见
[`docs/RELEASE_NOTES_1.4.3.md`](docs/RELEASE_NOTES_1.4.3.md)。

## 安装与启动

普通用户安装：

- `L2DConfigEditor-Setup-1.4.3-x64.exe`：一个安装包同时安装两个独立
...
`L2DConfigEditor-Setup-1.4.3-x64.exe` 覆盖安装最简单，不必先启动 Host。
